...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_ingredient(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Floor')
    ...
    def test_partial_update_recipe(self):
        """Test that updates a recipe using patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user, name='Summer'))
        new_tag = sample_tag(user=self.user, name='Autumn')
...
class RecipeImageUploadTest(TestCase):
    ...
    # setUp() iruns at the start of funtion, tearDown() runs at the end
    def tearDown(self):
        self.recipe.image.delete()

    def test_upload_image_to_recipe(self):
        """Test uploading image to a recipe model"""
    ...
    def test_upload_invalid_image(self):
        """Test uploading invalid image to the recipe"""
        url = image_upload_url(self.recipe.id)
